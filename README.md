...
<param ve-entity eid="Q1486" fill="#b71a1a" label="Buenos Aires">
<param ve-entity eid="Q1335" fill="#dc882f" label="Puerto de Montevideo">
<param ve-map center= "-34.881191, -57.147750" zoom="8" show-labels
...
title="Viaje de Buenos Aires a Montevideo"
basemap="Esri_WorldPhysical">
<param ve-map layer geojson active title="viaje" url="BuenosAiresColor.geojson">
...
Provincias de Australia y Brasil. 
<param ve-map show-labels
basemap="Esri_WorldPhysical">
<param ve-map layer geojson active title="Australia y Brasil" url="provincias2.geojson">
